...
const CommandBase = preload("uid://b7gbnb7wkgrrq") # res://addons/addon_lib/gdsh/command_base.gd
const Completion = preload("uid://bvqh57qm7jeuj") # res://addons/addon_lib/gdsh/completion.gd
const Console = preload("uid://cefnxpuiau33t") # res://addons/addon_lib/gdsh/console.gd
const Context = preload("uid://dlf6o3kxnojob") # res://addons/addon_lib/gdsh/context.gd
...
const Utils = preload("uid://b8jfwvgk40lay") # res://addons/addon_lib/gdsh/internal/utils.gd
